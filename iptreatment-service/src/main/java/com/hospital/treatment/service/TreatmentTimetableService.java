...
public class TreatmentTimetableService {
    ...
    private PackageInfo getPackageInfo(String packageName) {
        ...
        switch (packageName.toLowerCase()) {
            case "orthopaedics package 1":
                return new PackageInfo("Orthopaedics Package 1", "Orthopaedics", 
                    Arrays.asList("OPT1", "OPT2"), 2500.0, 4, 1);
            case "orthopaedics package 2":
                return new PackageInfo("Orthopaedics Package 2", "Orthopaedics", 
                    Arrays.asList("OPT3", "OPT4"), 3000.0, 6, 2);
            case "urology package 1":
                return new PackageInfo("Urology Package 1", "Urology", 
                    Arrays.asList("UPT1", "UPT2"), 4000.0, 4, 1);
            case "urology package 2":
                return new PackageInfo("Urology Package 2", "Urology", 
